      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="hero text-center mb-12">
          ...
          <form onSubmit={searchHandler} className="mt-6 relative">
            ...
            {/* Custom Dropdown */}
            {isDropdownVisible && (
              <div className="dropdown absolute left-0 ml-102 w-xl mt-2 bg-white dark:bg-gray-700 shadow-lg rounded-md z-10">
        ...
        <div className="crypto-table bg-white dark:bg-gray-900 shadow-lg rounded-lg overflow-hidden">
          <div className="table-layout p-4 grid grid-cols-5 gap-6 text-gray-700 font-semibold dark:text-gray-300">
            <p>#</p>
            <p>Coins</p>
            <p>Price</p>
            <p>24H Change</p>
          ...
          <div className="table-content divide-y divide-gray-200 dark:divide-gray-700">
            {displayCoin.slice(0, 10).map((item, index) => (
              <Link
                to={`/coin/${item.id}`}
                key={index}
                className="block p-4 grid grid-cols-5 items-center hover:bg-gray-50 transition-all duration-200 dark:hover:bg-gray-700"
              >
